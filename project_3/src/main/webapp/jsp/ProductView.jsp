					...
					<div class="card">
						<div class="card-body">
							...
							<div class="md-form">
								...
								<span class="pl-sm-5"><b>ProductCategory</b><span style="color: red;">*</span></span> </br>
 --%>
 <span class="pl-sm-5"><b>ProductCategory</b><span style="color: red;">*</span></span> </br>
<div class="col-sm-12">
	<div class="input-group">
		<div class="input-group-prepend">
			<div class="input-group-text">
				<i class="fa fa-address-card grey-text" style="font-size: 1rem;"></i>
			</div>
		</div>
		<%
